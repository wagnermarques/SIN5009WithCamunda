...
** Rodando nosso ESB (Talend )
   ...
   #+RESULTS: rodando esb
   : 
   : [wagner@Unknown container]$ [wagner@Unknown container]$ [wagner@Unknown container]$ [wagner@Unknown container]$ [wagner@Unknown container]$ [wagner@Unknown container]$ [wagner@Unknown container]$ [2] 17750
