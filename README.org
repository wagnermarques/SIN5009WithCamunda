...
**** undeploy     
   ...
   #+BEGIN_SRC shell :session s1 :results output :exports both
      ...
      deploymentId=285500be-0732-11ea-83ce-7440bbfe2c2f
...
**** iniciando um processo
   ...
   : bash: http://localhost:8080/engine-rest/procIdCliente:1:fb3f24c6-0732-11ea-83ce-7440bbfe2c2f/start: No such file or directory
   : .
