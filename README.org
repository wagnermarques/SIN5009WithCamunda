...
* Introducao e Apresentacao deste material   
  ...
  mais possibilidade de reproduzir o trabalho novamente.
...
** Setup Environment 
   ...
   máquina de trabalho. Indicando os locais corretos, todos os outros
...
*** Fazendo undeploy de processos
   ...
   #+BEGIN_SRC shell :session s1 :results output :exports both
      ...
      deploymentId=e784a3e4-0afb-11ea-8a74-7440bbfe2c2f
