...
** Rodando o camunda platform
  ...
  : 
  : CAMUNDA_BPM_PLATFORM_HOME/start-camunda.sh
  : [wagner@nsipc163 SIN5009WithCamunda]$ [wagner@nsipc163 SIN5009WithCamunda]$ [wagner@nsipc163 SIN5009WithCamunda]$ Using CATALINA_BASE:   /home/wagner/wagnerdocri@gmail.com3/envs/env-dev/sources/SIN5009WithCamunda/tools/camunda_bpm/server/apache-tomcat-9.0.19
...
** Acessando camunda bpm   
   ...
   #+BEGIN_SRC shell :session s1 :results output :exports both
      ...
      deploymentId=7c14343e-0ad2-11ea-ae44-b88584fd06d6
